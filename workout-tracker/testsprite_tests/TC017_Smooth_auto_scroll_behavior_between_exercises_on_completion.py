...
async def run_test():
    ...
    try:
        ...
        # -> Begin completing all sets for the first visible exercise in desktop viewport by clicking each set control so the exercise auto-collapses; then emulate mobile viewport and repeat for the next exercise to observe scrolling behavior.
        ...
        # -> Recover the app state by opening the same URL in a new tab to attempt a fresh load of the SPA, then inspect the new tab for exercise cards and interactive controls.
        await page.goto("http://localhost:5173/login/TEST123", wait_until="commit", timeout=10000)
